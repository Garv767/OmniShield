    ...
    <div className="p-8 min-h-[calc(100vh-53px)] flex flex-col space-y-6 bg-slate-50 font-sans overflow-y-auto">
      ...
      {prediction && sampleData && (
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 font-sans flex-grow">
          ...
          {/* Risk Score Card */}
          <div className="md:col-span-1 bg-white border border-slate-200 rounded-xl p-6 flex flex-col items-center justify-center text-center shadow-sm">
            <h2 className="text-[10px] font-bold text-slate-500 uppercase tracking-wider mb-6">Mule Probability Score</h2>
